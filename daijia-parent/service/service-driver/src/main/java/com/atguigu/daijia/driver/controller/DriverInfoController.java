...
public class DriverInfoController {
    ...
    @GetMapping("/getDriverLoginInfo/{driverCode}")
    public Result<DriverLoginVo> getDriverLoginInfo(@PathVariable("driverCode") Long driverCode) {
        return Result.ok(driverInfoService.getDriverLoginInfo(driverCode));
    }
    ...
    public Result<Boolean> createDriverFaceModel(@RequestBody DriverFaceModelForm driverFaceModelForm) {
        driverInfoService.createDriverFaceModel(driverFaceModelForm);
